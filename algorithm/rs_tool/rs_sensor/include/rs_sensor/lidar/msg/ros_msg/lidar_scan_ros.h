...
#include "rs_sensor/lidar/msg/ros_msg/lidar_packet_ros.h"
...
struct Printer<::rslidar_msgs::rslidarScan_<ContainerAllocator> > {
    ...
    static void
    stream(Stream &s, const std::string &indent, const ::rslidar_msgs::rslidarScan_<ContainerAllocator> &v) {
        s << indent << "header: ";
        s << std::endl;
