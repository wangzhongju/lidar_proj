...
{
  new (message_memory) perception_ros2_msg::msg::Lane(_init);
}

void Lane_fini_function(void * message_memory)
{
  auto typed_message = static_cast<perception_ros2_msg::msg::Lane *>(message_memory);
  typed_message->~Lane();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Lane_message_member_array[5] = {
  {
    "lane_id",  // name
    ...
    offsetof(perception_ros2_msg::msg::Lane, lane_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(perception_ros2_msg::msg::Lane, curve),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(perception_ros2_msg::msg::Lane, end_points),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(perception_ros2_msg::msg::Lane, measure_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(perception_ros2_msg::msg::Lane, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Lane_message_members = {
  ...
  "Lane",  // message name
  5,  // number of fields
  sizeof(perception_ros2_msg::msg::Lane),
...
get_message_type_support_handle<perception_ros2_msg::msg::Lane>()
{
  return &::perception_ros2_msg::msg::rosidl_typesupport_introspection_cpp::Lane_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, perception_ros2_msg, msg, Lane)() {
  return &::perception_ros2_msg::msg::rosidl_typesupport_introspection_cpp::Lane_message_type_support_handle;
}
