...
bool perception_ros2_msg__msg__point4f__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "perception_ros2_msg.msg._point4f.Point4f",
        full_classname_dest, 40) == 0);
  }
  perception_ros2_msg__msg__Point4f * ros_message = _ros_message;
  {  // x
  ...
  {  // z
    ...
    if (!std_msgs__msg__float32__convert_from_py(field, &ros_message->z)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // i
    ...
    if (!std_msgs__msg__u_int16__convert_from_py(field, &ros_message->i)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * perception_ros2_msg__msg__point4f__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Point4f */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("perception_ros2_msg.msg._point4f");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Point4f");
  ...
  perception_ros2_msg__msg__Point4f * ros_message = (perception_ros2_msg__msg__Point4f *)raw_ros_message;
  {  // x
    PyObject * field = NULL;
  ...
  {  // z
    PyObject * field = NULL;
    field = std_msgs__msg__float32__convert_to_py(&ros_message->z);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // i
    PyObject * field = NULL;
    field = std_msgs__msg__u_int16__convert_to_py(&ros_message->i);
    if (!field) {
      return NULL;
    }
    {
