...
bool perception_ros2_msg__msg__point3d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "perception_ros2_msg.msg._point3d.Point3d",
        full_classname_dest, 40) == 0);
  }
  perception_ros2_msg__msg__Point3d * ros_message = _ros_message;
  {  // x
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * perception_ros2_msg__msg__point3d__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Point3d */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("perception_ros2_msg.msg._point3d");
  ...
  perception_ros2_msg__msg__Point3d * ros_message = (perception_ros2_msg__msg__Point3d *)raw_ros_message;
  {  // x
    PyObject * field = NULL;
