...
bool perception_ros2_msg__msg__point2f__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "perception_ros2_msg.msg._point2f.Point2f",
        full_classname_dest, 40) == 0);
  }
  perception_ros2_msg__msg__Point2f * ros_message = _ros_message;
  {  // x
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * perception_ros2_msg__msg__point2f__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Point2f */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("perception_ros2_msg.msg._point2f");
  ...
  perception_ros2_msg__msg__Point2f * ros_message = (perception_ros2_msg__msg__Point2f *)raw_ros_message;
  {  // x
    PyObject * field = NULL;
