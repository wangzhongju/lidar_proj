    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'perception_ros2_msg.msg.Objects')
            logger.debug(
            ...
            from perception_ros2_msg.msg import Object
...
class Objects(metaclass=Metaclass_Objects):
    ...
    _fields_and_field_types = {
        ...
        'device_id': 'std_msgs/Int32',
        'objects': 'sequence<perception_ros2_msg/Object>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['perception_ros2_msg', 'msg'], 'Object')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Int32
        self.device_id = kwargs.get('device_id', Int32())
    ...
    def device_id(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'device_id' field must be a sub message of type 'Int32'"
