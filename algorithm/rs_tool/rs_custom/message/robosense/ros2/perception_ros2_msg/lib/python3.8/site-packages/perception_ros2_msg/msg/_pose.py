...
class Pose(metaclass=Metaclass_Pose):
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Float32
        self.roll = kwargs.get('roll', Float32())
        from std_msgs.msg import Float32
        self.pitch = kwargs.get('pitch', Float32())
        from std_msgs.msg import Float32
        self.yaw = kwargs.get('yaw', Float32())
        from std_msgs.msg import Int32
    ...
    def roll(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Float32), \
                "The 'roll' field must be a sub message of type 'Float32'"
        self._roll = value
    ...
    def pitch(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Float32), \
                "The 'pitch' field must be a sub message of type 'Float32'"
        self._pitch = value
    ...
    def yaw(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Float32), \
                "The 'yaw' field must be a sub message of type 'Float32'"
        self._yaw = value
