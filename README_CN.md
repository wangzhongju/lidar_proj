...
```
## env
docker images:  nvidia/cudagl:v8

## 拉取代码
git clone ssh://git@192.168.5.10:9922/wangzhongju/lidar_proj.git

## 创建环境
./docker/docker.sh start
./docker.docker.sh into

note：忽略以下信息
----------------------
WARNING: Requirement '/workspace/third_party/x86/2004/opencv-4.9/wheel/opencv-4.9.0-py3-none-any.whl' looks like a filename, but the file does not exist
ERROR: Could not install packages due to an EnvironmentError: [Errno 2] No such file or directory: '/workspace/third_party/x86/2004/opencv-4.9/wheel/opencv-4.9.0-py3-none-any.whl'

cp: cannot stat '/workspace/third_party/x86/2004/opencv-4.9/wheel/config*.py': No such file or directory
----------------------
